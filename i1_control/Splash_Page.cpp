...
Splash_Page::Splash_Page(const char *const *menu_text, Menu_Controller *menu_controller, Parameter_Container *parameter_container):Menu_Page(menu_text, menu_controller, parameter_container){
  m_enter_enabled = false;
  m_back_enabled = false;
  m_encoder_enabled = false;
  m_number_of_menu_items = 3;
}
