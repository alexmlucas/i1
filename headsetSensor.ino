...
//                       XA      YA      ZA      XG      YG      ZG
int MPUOffsets[6] = {277, -1587, 1043, -57, -3, -14}; //MPU6050 on balanceing bot
...
void updateLed(int serialInteger){
  switch(serialInteger){
    case 1:
