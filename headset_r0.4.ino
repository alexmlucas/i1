...
// Display includes and initialisation:
  ...
  while (Serial.available() > 0){
     ...
     if (serialCharacter != endMarker){
      ...
      if(serialCharacter == 114){
        ...
        updateDisplay(String(serialCharacter - 48));
     ...
     /*if (serialCharacter == 114){
      // Request for IMU data received
      transmitImuData();
     } else if (serialCharacter >= 1 && serialCharacter <= 7){
      // Request to update the display received
        updateDisplay("updating..."); 
     }*/

     // replace following if with switch statement?

     
     /*if (serialCharacter == 'r'){
      
     } else if (serialCharacter == '1'){
      // Request to update the display received
        updateDisplay("1"); 
     }
  }*/
...
void updateDisplay(String stringToDisplay){
  display.clearDisplay();
